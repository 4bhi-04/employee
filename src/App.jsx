    ...
    return(
        ...
        <div id="home">
            ...
            {products.map(function(pp){
                return(
                    <Card name={pp.name} age={pp.age} city={pp.city} country={pp.country} status={pp.status} hobby={pp.hobby} coverPic={pp.coverPic}
                    profilePic={pp.profilePic} favoriteFoodPic={pp.favoriteFoodPic} avatar={pp.avatar} skills={pp.skills}
                    ></Card>
                )
            })}
        </div> 
